module Afterburner
  module Protocols
    ...
    # symbol name of your searching method, and then use the :as_search_results
    # method for queries. For example, if you are wrapping acts_as_indexed, the
    # searching method there is called 'with_query'. Thus:
    #
